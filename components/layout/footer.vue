      ...
      <div class="container p-8 mx-auto">
        <div class="grid justify-between grid-cols-4 gap-6 2xl:flex">
          ...
          <nav class="grid col-span-2 md:col-span-1">
            <!-- TODO 주소가 이게 맞나 몰?루 -->
            <NuxtLink class="text-xl" v-for="link in footerPath" :href="link.path">
              {{ link.name }}
            </NuxtLink>
          </nav>
          <section>
            <h2 class="col-span-2 mb-5 text-xl md:col-span-1">
              <NuxtLink href="/projects/portfolio">PROJECTS</NuxtLink>
            </h2>
            <h2 class="col-span-2 text-xl md:col-span-1">
              <NuxtLink href="/capabilities/mechanical">CAPABILITIES</NuxtLink>
            </h2>
            <ul class="mt-3">
              <li><NuxtLink href="/capabilities/mechanical">Mechanical</NuxtLink></li>
              <li>
                <NuxtLink href="/capabilities/fireProtection">Fire Protection</NuxtLink>
              </li>
              <li>
                <NuxtLink href="/capabilities/design">Design</NuxtLink>
              </li>
              <li><NuxtLink href="/capabilities/pipeline">Pipeline</NuxtLink></li>
            </ul>
          </section>
        ...
        <div class="flex justify-end gap-10 mt-4">
          ...
          <NuxtLink href="https://www.facebook.com/Hyoungwon.Inc/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-7 h-7"
              viewBox="0 0 16 16"
    ...
    <div class="bg-gray-700">
      ...
      >
        ...
        <div class="flex gap-10">
          <NuxtLink class="" href="/" target="_blank">
            <!-- TODO: 약관추가 -->
            Terms of Service
          </NuxtLink>
          <NuxtLink class="" href="/" target="_blank">
