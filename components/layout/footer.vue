      ...
      <div class="container p-8 mx-auto">
        <div class="grid justify-between grid-cols-4 gap-6 2xl:flex">
          ...
          <section>
            ...
            <ul class="mt-3">
              <li><a href="/capabilities/mechanical">하이테크</a></li>
              <li>
                <a href="/capabilities/fireProtection">소방설비</a>
              </li>
              <li><a href="/capabilities/pipeline">EPC</a></li>
            </ul>
          </section>
          <div class="col-span-2"></div>
          <section class="col-span-4 md:col-span-2">
            <h2 class="mb-5 text-xl">OFFICES</h2>
            <p class="">경기도 파주시 경의로 1204, 월드타워 10차 10층 1007호 ㈜형원이엔지​</p>
          </section>
        </div>
