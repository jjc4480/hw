    ...
    >
      ...
      >
        ...
        >
          ...
          <section>
            <h2
              class="text-xl md:col-span-1 col-span-2"
            >
              CAPABILITIES
            </h2>
            <ul
